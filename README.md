...
[![GitHub stars](https://img.shields.io/github/stars/rsre/esphome-altherma)](https://github.com/rsre/esphome-altherma/stargazers)
...
🌐 [Web Installer](https://rsre.github.io/esphome-altherma/) · 💬 [HA Community](https://community.home-assistant.io/t/esphome-altherma-monitor-your-daikin-altherma-3-heat-pump-via-x10a/1000476) · 🗨️ [Discussions](https://github.com/rsre/esphome-altherma/discussions) · 📖 [Emoncms Setup Guide](https://jjohnsen.no/2026/esphome-altherma-emoncms-setup-guide/)
...
1. Open the [Web Installer](https://rsre.github.io/esphome-altherma/) in Chrome/Edge
...
1. Open https://rsre.github.io/esphome-altherma/ and click **Connect**
...
2. Clone this repository:
   ```sh
   git clone https://github.com/rsre/esphome-altherma.git
   cd esphome-altherma
   ```
...
- `!include github://rsre/esphome-altherma/...@main` is for **"Take Control" in ESPHome Device Builder**. In this mode, YAML files are fetched from GitHub.
...
If you have a successful install with a model not listed above, please share it in the [Discussions](https://github.com/rsre/esphome-altherma/discussions).
